...
namespace Ants {
	...
	public interface IGameState {
        ...
        /// <summary>
        ///   My ants given by the input (just for validation).
        /// </summary>
        List<Ant> MyAntsTurn { get; }
		...
		/// </summary>
        List<AntHill> VisibleEnemyHills { get; }
        
        /// <summary>
        /// Gets a list of known enemy hills. These don't have to be visible currently. 
        /// They could already be destroyed, but the list will be updated each time the location is visible.
        /// </summary>
        List<AntHill> KnownEnemyHills { get; }
		...
		/// </summary>
		List<Location> VisibleFoodTiles { get; }
        ...
        bool IsAccessible(Location location);

        List<Location> GetPassableNeighbours(Location location);

        List<Location> GetFrontier();
    }
}